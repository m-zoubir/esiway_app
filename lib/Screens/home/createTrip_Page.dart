...
// import 'package:esi_way/couleur.dart';
//
...
//                                         width: largeur * 0.11,
//                                         height: hauteur * 0.025,
//                                         child: const MyText(text: "Date", weight: FontWeight.w700, fontsize: 14, color: Color(0xff20236C))),
//
//                                     SizedBox(height: hauteur * 0.005),
//
//                                     /// +Date Filed
...
//                                         width: largeur * 0.5,
//                                         child: Container(
//                                             decoration:  BoxDecoration(boxShadow: [BoxShadow(blurRadius: 18, color: Color.fromRGBO(32, 35, 108, 0.15))],color: Colors.white,borderRadius: BorderRadius.circular(5)),
//                                             child: Row(
...
//                                                 ),
//
//                                                 MyText(text: date!, weight: FontWeight.w500, fontsize: 14, color: const Color(0xFF20236C)),
//                                                 SizedBox(width: 5,),
//
//                                               ],
//                                             )
...
//                               mainAxisAlignment: MainAxisAlignment.spaceBetween ,
//                               children: [
//                                 SimpleButton(backgroundcolor: bags ?BLUE_CIEL :Colors.white , size: Size(largeur*0.2, hauteur*0.00875), radius: 3, text: "Bags", textcolor: BLUE, fontsize: 12, fct:(){bags=!bags;setState(() {});},blur: 18),
//                                 SimpleButton(backgroundcolor: talking ?BLUE_CIEL :Colors.white  , size: Size(largeur*0.277, hauteur*0.00875), radius: 3, text: "Talking", textcolor: BLUE, fontsize: 12, fct:(){(talking=!talking)!;setState(() {});},blur: 18),
//                                 SimpleButton(backgroundcolor: animals ?BLUE_CIEL :Colors.white  , size: Size(largeur*0.277, hauteur*0.00875), radius: 3, text: "Animals", textcolor: BLUE, fontsize: 12, fct:(){(animals=!animals)!;setState(() {});},blur: 18),
//
//                               ],
//                             ),
//                             Row(
//                               mainAxisAlignment: MainAxisAlignment.center,
//                               children: [
//                                 SimpleButton(backgroundcolor: smoking ?BLUE_CIEL :Colors.white  , size: Size(largeur*0.277, hauteur*0.00875), radius: 3, text: "Smoking", textcolor: BLUE, fontsize: 12, fct:(){(smoking=!smoking)!;setState(() {});},blur: 18),
//                                 SizedBox(width: largeur*0.07),
//                                 SimpleButton(backgroundcolor: others ?BLUE_CIEL :Colors.white , size: Size(largeur*0.277, hauteur*0.00875), radius: 3, text: "Other", textcolor: BLUE, fontsize: 12, fct:(){(others=!others)!;setState(() {});},blur: 18),
//
//                               ],
//                             ),
//
